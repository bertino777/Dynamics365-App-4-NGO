...
# C Sharp plug-ins
*Click on the icon to see C sharp plu-in codes*

[<img alt ="ALM" width="px" height="60px" src="images/c_sharp_plugin.png" />](https://github.com/bertino777/Dynamics365-App-4-NGO/blob/main/CSharpPlugIns.md)
